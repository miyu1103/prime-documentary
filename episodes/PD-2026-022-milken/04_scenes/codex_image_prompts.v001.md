# PD-2026-022-milken — Codex Image Prompts v001 (MEGA-PROMPT PACK)

> Episode: **EP22 — Michael Milken: Genius, or the Face of Greed?** (junk-bond king; pleaded guilty; pardoned 2020.)
> Profile: mid, target 30:00. Risk: **R3 (LIVING person who PLEADED GUILTY and was later PARDONED).**
> Image pipeline: **Codex image generation = PRIMARY** (SDXL is fallback only). Generate **exactly ONE image per
