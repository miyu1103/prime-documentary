...
**R3++++ 2026-07-26: motif de-repetition per owner directive (max-2-per-beat, evolving recurrences, 61 rows converted: object 35 = ACT0 S003/S004/S010/S011/S014・ACT1 S022/S023/S038/S039/S042/S045/S049/S052・ACT2 S065/S068/S073/S074/S077/S078/S097・ACT3 S115/S116/S125/S126/S143/S144/S147/S148/S149・ACT4 S159/S188・ACT5 S198/S199/S202/S203、★HP 26 = ACT1 S033–S036/S056/S057・ACT2 S081/S087/S088/S094/S095・ACT3 S123/S124/S131/S140・ACT4 S152/S153/S162–S165/S171/S180/S181/S184/S191), counts/lanes unchanged.** 新ルール＝CODEX_A §5.5a（①1ビート同一motif最大2枚 ②幕またぎ再登場は可視の状態変化必須・同状態撮り直し禁止・clockは running/expired の2状態のみ ③Codex one-shot＝再生成はQC fail時のみ・pick-from-variants禁止 ④TORTURE GATE不変）。spine 状態連鎖を明文化: letter = typed(S071)→sealed(S072)→delivered(S075)→locked(S076)→**court exhibit(S159・新設)**→un-buried(S196–S197)→chapter(S200–S201)／box = drawer(S037)→shadow(S066)→carton(S067)→courtroom(S083)。クラスタ縮減（同状態バリエーション数）: letter 20→10(+exhibit 1)・box 6→3・radiator 3→2・clock 4→2・witness stand 6→2・squadroom 6→2・oath pen 5→2・field phone 4→2・survivor silhouette 4→2・1989 gallery 4→2・reporter 4→2・files 4→2・organizing 4→2・agents 4→2・apology 4→2・gallery rise 3→2・teacher 3→2・center 3→2・letter unburied 4→2・chapter 4→2。owner 指定の新シーンを実装: squad-room coffee pot 3am(S038)・Reader newsstand 1990 snow(S097・masthead smear)・Area 2 era 連作 sodium 1982(S011)→boarded 2006(S125)→dawn(S198)・commutation pen(S131 hands)・boat wake 遠景(S141・船名なし＝file 既定の「可読の船名を描かない」stance と一致・Q5 で目視)・CPS textbook press(S188)・CTJC doorway(S182 既存 keep)・pension envelope(S176 既存 keep)。lane math 125/85 EXACTLY 不変（★HP の S番号集合は R3+ の85枚と同一・also_thumb S001/S066/S128/S186 不変・counts/§3.3 不変・全 ban 不変）。§4.4 の covers_scene_id 8本を kept 行へ再ポイント（F019→S043・F038→null・F101→S114・F106→S142・F118→S145・F128→S138・F147→S167・F152→S182）＋§7.3 対応更新。Q4 watch-list を新クラスタ（状態連鎖・輪転機ペア・crowd 新顔・hands-macro 群・civic 外観群）に更新。Gates: `check_prompt_diversity.py` default **PASS (0 dup-pairs)**・`--threshold 0.35` same-series **5→3**（残3 = T01~T02/T01~T03＝意図した thumb_face 3枚セットの共通フォーマット語・M10~M23＝報告書を打つ刑事の手と death row で leaflet を打つ手という設計上の韻・別ビート/別時代/別 setting）・`check_planning_package.py 55 burge --require-r3` **PASS**・S001–S210 gap-free 210行・[HSTYLE]=85（canonical 集合一致を機械照合）・ban sweep 0 hits（R-TORTURE-DEPICT 含む）。
