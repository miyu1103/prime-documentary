# EP65 marmet — Codex 画像生成 **1本で完結する発注** v001（**現在 224枚**・1プロンプト1枚）

> ※ 以下の本文中に残る「219枚」「223枚」は **追記前の古い数** である。現在の正しい数はここだけを見ること：
> **プレート 224枚（R001–R224、欠番なし）・`mandatory_stills` 220件（THUMB の R217/R218/R219/R224 を除く）**
...
**R001–R219 は一枚も変わりません。**この §7 は**追加だけ**です。合計は **224枚**になります（R220–R223 の4枚＋末尾のサムネ用 R224 、1枚）。
...
`episodes/PD-2026-065-marmet/episode_spec.v001.json` の `mandatory_stills` は **220件** です。
**プレートは全部で 224枚だが、THUMB の4枚（`R217` `R218` `R219` `R224`）は意図的に外してある。** サムネは本編のカットにならないので、宣言すると `check_spec_satisfied.py` が
「宣言された静止画がどのカットにも無い」で落ちる。
...
### ★再発注 2（2026-08-05・全224枚目視QCの不合格7枚）

全224枚を目視した（`runs/qc/marmet_plate_verdicts.v001.md`）。**ACCEPT 196 / FLAG 19 / REJECT 7**。寸法不合格は0枚（全枚 3840×2160）。

重いのは**顔が3枚**出たことである。うち2枚は発注が**「紙」と「法令集」**で、人を一言も書いていない。

原因は機械的である：**正典の `[NEG]` に顔を抑える語が1つも無かった**。制服・バッジ・白衣は禁じていたが、人を描かせない語は無かった。守っていたのは個々の本文の「no face」だけで、**人を書いていない発注には保護がゼロ**だった。

§2 の `[NEG]` に顔の語を追加済み。さらに `scripts/check_image_order_neg.py` を新設し、**顔・文字・手書き・紋章・数字の五つを欠く発注書を拒否**するようにした（実際に落ちることを確認済み）。

| 新 | 廃止 | 却下理由 |
|---|---|---|
| `R227` | `R016` | ACT_1. Second county courthouse. Rejected on period: 1970s cars. |
| `R228` | `R019` | ACT_1. The R018 sheet lifted to the light. Rejected on face + cursive handwriting + pity. |
| `R229` | `R041` | ACT_1. Statute volume open at the section 15(c) paragraph. Rejected on face + pity. |
| `R230` | `R065` | ACT_2. The visitor's hand taking the form. Rejected on face. |
| `R231` | `R089` | ACT_3. Closing beat of the whole-cloth sequence. Rejected: hardware bolt, not a bolt of cloth. |
| `R232` | `R115` | ACT_3. The blank form from directly above. Rejected: flat graphic, no viewpoint, mean 204.7 / sd 7.9. |
| `R233` | `R190` | ENDING. The admission desk in late afternoon. Rejected: form filled in by hand in name-shaped fields. |

**下の本文は全て展開済みの完全形**（`[STYLE]` も `[NEG]` も書き切ってある）。**`[STYLE]` / `[NEG]` トークンに戻さない。**

- `R227.png`
A second county courthouse of different stone and different proportion from any other in this film, seen straight down a narrow small-town main street from about eighty yards away, its clock tower rising above two-storey brick and painted-timber shopfronts on both sides of the street, and parked at the kerb along the right-hand side four ordinary American cars of the late two-thousands - a silver mid-size saloon, a dark green sport utility vehicle, a grey pickup truck and a maroon minivan, all of them plain, dusty and unremarkable, no vehicle older than about fifteen years anywhere in the frame, the street wet from recent rain, flat grey winter daylight, no person in the street and nothing written on any building or vehicle, cinematic still, muted natural colour, flat overcast Appalachian daylight, low contrast, low-key but never crushed: shadows keep their detail and the frame reads clearly on a phone screen, soft falloff toward the edges, shallow depth of field, restrained documentary framing, West Virginia between 2009 and 2012, an ordinary care facility and ordinary domestic interiors, institutional but never clinical, worn unglamorous surfaces, nothing staged for advertising, ultra-detailed, photoreal, 4K, 16:9, fine film grain, no text, no lettering, no numerals, no watermark, no logo, no signage Avoid: text, lettering, numerals, handwriting, legible signature, cursive writing, seals, emblems, logos, signage, name plates, room numbers, a person lying in a hospital bed, hospital bed, ventilator, oxygen mask, IV drip, monitor trace, syringe, medication, nurse, doctor, scrubs, stethoscope, uniform, badge, clinical scene, operating theatre, laboratory, wheelchair, courtroom interior, gavel, judge's bench, prison bars, razor wire, handcuffs, banknotes, cash, coins, scales of justice, hourglass, a hand on a shoulder, a tear, crying, a lonely old person lit for pity, golden hour, sunset glow, postcard scenery, drone shot, cosy fireplace, Christmas, tropical, modern smartphones, laptops, glossy advertising lighting, flat CGI, cartoon, illustration, oversaturated

- `R228.png`
A single sheet of paper lifted from a desk and held at an angle so that raking window light crosses its surface from the left, the sheet held only by two fingertips entering the frame at the bottom edge with a plain dark sleeve and no arm, no shoulder, no head and no person visible anywhere in the picture, the sheet carrying one short block of grey printing about a third of the way down and absolutely nothing else on it, that printing dissolved into a soft even grey band with no readable characters and no letterforms of any kind, the paper slightly translucent where the light passes through it, an out-of-focus office interior behind, cinematic still, muted natural colour, flat overcast Appalachian daylight, low contrast, low-key but never crushed: shadows keep their detail and the frame reads clearly on a phone screen, soft falloff toward the edges, shallow depth of field, restrained documentary framing, West Virginia between 2009 and 2012, an ordinary care facility and ordinary domestic interiors, institutional but never clinical, worn unglamorous surfaces, nothing staged for advertising, ultra-detailed, photoreal, 4K, 16:9, fine film grain, no text, no lettering, no numerals, no watermark, no logo, no signage Avoid: text, lettering, numerals, handwriting, legible signature, cursive writing, seals, emblems, logos, signage, name plates, room numbers, a person lying in a hospital bed, hospital bed, ventilator, oxygen mask, IV drip, monitor trace, syringe, medication, nurse, doctor, scrubs, stethoscope, uniform, badge, clinical scene, operating theatre, laboratory, wheelchair, courtroom interior, gavel, judge's bench, prison bars, razor wire, handcuffs, banknotes, cash, coins, scales of justice, hourglass, a hand on a shoulder, a tear, crying, a lonely old person lit for pity, golden hour, sunset glow, postcard scenery, drone shot, cosy fireplace, Christmas, tropical, modern smartphones, laptops, glossy advertising lighting, flat CGI, cartoon, illustration, oversaturated, face, human face, facial features, portrait, eyes, looking at camera, person facing camera, head and shoulders, elderly person's face, profile of a face

- `R229.png`
A heavy hardbound volume of state statutes lying open flat on a plain wooden desk, photographed from slightly above and to one side, nobody in the picture at all and no hand, arm, shoulder or figure anywhere in the frame, the two open pages showing one short paragraph of grey printing about halfway down the left page and otherwise blank, that printing dissolved to a soft grey band with no readable characters, a plain yellow pencil laid along the gutter between the pages, a switched-off desk lamp standing beyond the book, flat grey afternoon light from a window out of frame to the left, cinematic still, muted natural colour, flat overcast Appalachian daylight, low contrast, low-key but never crushed: shadows keep their detail and the frame reads clearly on a phone screen, soft falloff toward the edges, shallow depth of field, restrained documentary framing, West Virginia between 2009 and 2012, an ordinary care facility and ordinary domestic interiors, institutional but never clinical, worn unglamorous surfaces, nothing staged for advertising, ultra-detailed, photoreal, 4K, 16:9, fine film grain, no text, no lettering, no numerals, no watermark, no logo, no signage Avoid: text, lettering, numerals, handwriting, legible signature, cursive writing, seals, emblems, logos, signage, name plates, room numbers, a person lying in a hospital bed, hospital bed, ventilator, oxygen mask, IV drip, monitor trace, syringe, medication, nurse, doctor, scrubs, stethoscope, uniform, badge, clinical scene, operating theatre, laboratory, wheelchair, courtroom interior, gavel, judge's bench, prison bars, razor wire, handcuffs, banknotes, cash, coins, scales of justice, hourglass, a hand on a shoulder, a tear, crying, a lonely old person lit for pity, golden hour, sunset glow, postcard scenery, drone shot, cosy fireplace, Christmas, tropical, modern smartphones, laptops, glossy advertising lighting, flat CGI, cartoon, illustration, oversaturated, face, human face, facial features, portrait, eyes, looking at camera, person facing camera, head and shoulders, elderly person's face, profile of a face

- `R230.png`
A single bare hand on the visitor's side of a reception counter, closing on the near edge of a printed form that has just been slid across to it, the hand and a plain unmarked shirt cuff entering the frame from the bottom right corner and nothing else of the person in the picture - no arm above the wrist, no shoulder, no head, no face and no second person anywhere in the frame, the counter running across the lower third at waist height, the form squared on it with its printing dissolved to soft grey with no readable characters, the space behind the counter empty and slightly out of focus, flat grey afternoon light, cinematic still, muted natural colour, flat overcast Appalachian daylight, low contrast, low-key but never crushed: shadows keep their detail and the frame reads clearly on a phone screen, soft falloff toward the edges, shallow depth of field, restrained documentary framing, West Virginia between 2009 and 2012, an ordinary care facility and ordinary domestic interiors, institutional but never clinical, worn unglamorous surfaces, nothing staged for advertising, ultra-detailed, photoreal, 4K, 16:9, fine film grain, no text, no lettering, no numerals, no watermark, no logo, no signage Avoid: text, lettering, numerals, handwriting, legible signature, cursive writing, seals, emblems, logos, signage, name plates, room numbers, a person lying in a hospital bed, hospital bed, ventilator, oxygen mask, IV drip, monitor trace, syringe, medication, nurse, doctor, scrubs, stethoscope, uniform, badge, clinical scene, operating theatre, laboratory, wheelchair, courtroom interior, gavel, judge's bench, prison bars, razor wire, handcuffs, banknotes, cash, coins, scales of justice, hourglass, a hand on a shoulder, a tear, crying, a lonely old person lit for pity, golden hour, sunset glow, postcard scenery, drone shot, cosy fireplace, Christmas, tropical, modern smartphones, laptops, glossy advertising lighting, flat CGI, cartoon, illustration, oversaturated, face, human face, facial features, portrait, eyes, looking at camera, person facing camera, head and shoulders, elderly person's face, profile of a face

- `R231.png`
A long roll of plain undyed woven cloth, half re-rolled onto itself and lying alone on a bare wide wooden table, the loose end of the cloth still lying flat across the table in front of the roll with one soft fold standing up in it, the weave plain and completely without pattern, print or marking of any kind, no scissors and no other object on the table, the room around it emptying of light as the afternoon ends so the far end of the table falls away into shadow while the cloth still holds a soft grey highlight along the top of the roll, seen from table height from about four feet away, cinematic still, muted natural colour, flat overcast Appalachian daylight, low contrast, low-key but never crushed: shadows keep their detail and the frame reads clearly on a phone screen, soft falloff toward the edges, shallow depth of field, restrained documentary framing, West Virginia between 2009 and 2012, an ordinary care facility and ordinary domestic interiors, institutional but never clinical, worn unglamorous surfaces, nothing staged for advertising, ultra-detailed, photoreal, 4K, 16:9, fine film grain, no text, no lettering, no numerals, no watermark, no logo, no signage Avoid: text, lettering, numerals, handwriting, legible signature, cursive writing, seals, emblems, logos, signage, name plates, room numbers, a person lying in a hospital bed, hospital bed, ventilator, oxygen mask, IV drip, monitor trace, syringe, medication, nurse, doctor, scrubs, stethoscope, uniform, badge, clinical scene, operating theatre, laboratory, wheelchair, courtroom interior, gavel, judge's bench, prison bars, razor wire, handcuffs, banknotes, cash, coins, scales of justice, hourglass, a hand on a shoulder, a tear, crying, a lonely old person lit for pity, golden hour, sunset glow, postcard scenery, drone shot, cosy fireplace, Christmas, tropical, modern smartphones, laptops, glossy advertising lighting, flat CGI, cartoon, illustration, oversaturated

- `R232.png`
A single blank printed form lying on a desk, photographed from directly overhead with the camera about two feet above it so the sheet sits square in the frame and the edges of the desk fall entirely outside it, the desk surface visible as a narrow dark border of scuffed wood along two sides of the sheet, one soft window highlight falling across the upper left corner of the paper and a gentle shadow gathering along its lower right edge so the sheet reads as a real object lying on a real surface rather than a flat field, the paper's fibre and one faint crease visible in the raking light, the printing on it dissolved into two soft grey bands with no readable characters anywhere, cinematic still, muted natural colour, flat overcast Appalachian daylight, low contrast, low-key but never crushed: shadows keep their detail and the frame reads clearly on a phone screen, soft falloff toward the edges, shallow depth of field, restrained documentary framing, West Virginia between 2009 and 2012, an ordinary care facility and ordinary domestic interiors, institutional but never clinical, worn unglamorous surfaces, nothing staged for advertising, ultra-detailed, photoreal, 4K, 16:9, fine film grain, no text, no lettering, no numerals, no watermark, no logo, no signage Avoid: text, lettering, numerals, handwriting, legible signature, cursive writing, seals, emblems, logos, signage, name plates, room numbers, a person lying in a hospital bed, hospital bed, ventilator, oxygen mask, IV drip, monitor trace, syringe, medication, nurse, doctor, scrubs, stethoscope, uniform, badge, clinical scene, operating theatre, laboratory, wheelchair, courtroom interior, gavel, judge's bench, prison bars, razor wire, handcuffs, banknotes, cash, coins, scales of justice, hourglass, a hand on a shoulder, a tear, crying, a lonely old person lit for pity, golden hour, sunset glow, postcard scenery, drone shot, cosy fireplace, Christmas, tropical, modern smartphones, laptops, glossy advertising lighting, flat CGI, cartoon, illustration, oversaturated

- `R233.png`
An admission counter photographed straight on from the visitor's side at waist height in late afternoon light, nobody behind it and nobody in the frame, a single printed admission form lying squared on the counter with its long edge parallel to the frame, the form completely unused - its printing dissolved into soft grey bands with no readable characters, its ruled line running bare across the foot of it with nothing written on that line and no mark, no ink, no pen and no writing of any kind anywhere on the paper, the space beyond the counter empty and softly out of focus, the daylight gone flat and grey, cinematic still, muted natural colour, flat overcast Appalachian daylight, low contrast, low-key but never crushed: shadows keep their detail and the frame reads clearly on a phone screen, soft falloff toward the edges, shallow depth of field, restrained documentary framing, West Virginia between 2009 and 2012, an ordinary care facility and ordinary domestic interiors, institutional but never clinical, worn unglamorous surfaces, nothing staged for advertising, ultra-detailed, photoreal, 4K, 16:9, fine film grain, no text, no lettering, no numerals, no watermark, no logo, no signage Avoid: text, lettering, numerals, handwriting, legible signature, cursive writing, seals, emblems, logos, signage, name plates, room numbers, a person lying in a hospital bed, hospital bed, ventilator, oxygen mask, IV drip, monitor trace, syringe, medication, nurse, doctor, scrubs, stethoscope, uniform, badge, clinical scene, operating theatre, laboratory, wheelchair, courtroom interior, gavel, judge's bench, prison bars, razor wire, handcuffs, banknotes, cash, coins, scales of justice, hourglass, a hand on a shoulder, a tear, crying, a lonely old person lit for pity, golden hour, sunset glow, postcard scenery, drone shot, cosy fireplace, Christmas, tropical, modern smartphones, laptops, glossy advertising lighting, flat CGI, cartoon, illustration, oversaturated

**廃止：`R016` `R019` `R041` `R065` `R089` `R115` `R190`。カットに使わない（削除はしない）。** `mandatory_stills` は差し替え済み。
