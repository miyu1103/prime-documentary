# EP74 · ITAEWON — SCRIPT v007

> **Supersedes v006 for one reason: the narration master was generated and it came in long.**
>
> 348 chunks, 343 made, 0 failed. **Measured master 1,964.8 s, measured 184.3 wpm** — against a
> projection of 198.4 wpm and a runtime band of [1740, 1920]. The finished film would have been
> **32:54, fifty-four seconds over the ceiling.**
>
> **Why the projection was wrong, measured per section from `narration_index.v001.json`:**
> HOOK 212.4 wpm · OP 205.0 · **ACT_1 195.5** · ACT_2 194.0 · ACT_3 182.2 · ACT_4 181.9 ·
> **ACT_5 174.7** · ENDING 187.4. `--measure-section ACT_1` was the right instrument pointed at the
> wrong act: **ACT_1 is the third-FASTEST section in the film and runs 6.1 % ahead of the whole.**
> Measuring one early act and extrapolating will always over-estimate a film whose register slows as
> it argues. **Next episode: measure ACT_1 and the longest late act, and size from the mean.**
>
> v007 removes **~240 words from ACT_5**, which at 0.344 s per word is the most expensive prose in
> the film and is also the act `SCENE_PLAN.v002` §2.5 already recorded as a structural debt at 9:03
> planned against 9:48 delivered. **No sourced fact is cut.** Every removal is either a second
> rendering of something the film has already said in its own words, or a signpost.
>
> **Superseded note, kept for the record.** v006 fixed three defects found by `check_script_craft.py`.
>
> v005 was measured against the craft gate for the first time and returned **two hard failures and
> one warning**:
>
> 1. **Spoken call to action.** The ending said *subscribe*. The gate's own reason: **45 of 46 Shorts
>    that read a CTA aloud converted zero subscribers** (`docs/PD_SHORTS_TO_LONGFORM_FUNNEL.v001.md`).
>    v3 row 10 says the ending delivers the reveal and then *one specific ask* — and the measurement
>    says that ask must not be **spoken**. The endcard and the description carry it. The narration
>    does not.
> 2. **AI-smell phrase** — *"not just a"*, in ACT_4.
> 3. **Short-punch share 18.5 %** against a 20–35 % band. Six sentences split; nothing added.
>
> **Superseded note, kept for the record.** v005 superseded v004 with two changes, and the second one
> changed the film.
>
> **1. The structural fix.** `SCENE_PLAN.v001` §2.5 measured the act lengths and found ENDING at
> **4:10** against a designed 1:00, because every research region added in ledger v002 and v003
> touched the present day and so landed there. The minister block moves to ACT_4, where the state
> examines itself; the enforcement decree and the penalty bill move to ACT_5, where the law is. The
> October 2023 "no legislation yet" beat is **cut**: it sat after the December 2023 amendment and
> made the chronology read backwards.
>
> **2. `AB-02` is resolved, and the ending is different.** v004 said no appellate judgment could be
> verified. `FACTS_LEDGER.v004` establishes why: **there is no judgment, because both appeals were
> stopped** — Criminal Division 13 on 14 July 2025, Criminal Division 9-1 on 28 August 2025 — to
> wait for a commission that is still trying to establish what happened. The passage that said
> "here this film stops" is replaced by what the courts actually did. Ledger v004 also resolves
> `IT-58`: the transport operator's own count, 81,573 against 31,878, now opens ACT_1's second half.
>
> **Superseded note, kept for the record.** v004 was the revision written to THIS episode's own measured pace.
...
>
> **Design `EP74_itaewon_FILM_BIBLE.v002.md` · facts `EP74_itaewon_FACTS_LEDGER.v001`–`.v004.md` (the only source of any factual line) · contract
...
If you have been to any city in the world, you have walked up a street like this one. It is a shortcut. It is how people get from the station to the bars. Nobody goes the long way round.
...
Three point two metres is two cars side by side. It is a living room, turned on its end and stretched out for fifty metres.
...
So the state's knowledge of that street was not zero. Somebody had measured it. Somebody wrote it down. Somebody issued a penalty about it, in 2021.
<!-- IT-06 ✓ VERBATIM · OURS -->
...
A hundred thousand people is a stadium, arriving in one district, on foot, over about six hours, in the dark.
<!-- IT-55 ✓ VERBATIM · OURS — scale comparison -->

【Pictures: a station platform filling → ticket gates → an escalator, all backs, all motion blur. Number ticker on the hourly figures, f0→f24, Easing.out(Easing.cubic).】

The city knew how many. Not afterwards — that evening, in the ordinary course of running a railway.
<!-- IT-93, IT-94 ✓ VERBATIM -->

Eighty-one thousand five hundred and seventy-three people got off the train at Itaewon station that day, on figures from Seoul Transportation Corporation. On the equivalent Saturday a year earlier it had been thirty-one thousand eight hundred and seventy-eight.
<!-- IT-93 ✓ VERBATIM -->

Two point six times as many.
<!-- IT-93 ✓ VERBATIM -->

And they arrived in a curve anybody could read. Ten thousand seven hundred and forty-seven between six and seven. Eleven thousand eight hundred and seventy-three between seven and eight. Eleven thousand six hundred and sixty-six between eight and nine.
<!-- IT-94 ✓ VERBATIM -->

One stop from that alley, a state-owned company was counting them as they came, hour by hour.
<!-- IT-93, IT-94 ✓ VERBATIM · OURS -->
...
Eleven reports. Not noise complaints. Reports about dangerous levels of overcrowding, made to the police, by the people standing in it.
<!-- IT-13 ✓ VERBATIM -->
...
Three hours and thirty-seven minutes is long enough to drive across a country. It is long enough that the shift you started the evening on is a different shift by the end of it.
...
A call is information arriving at an organisation, and what an organisation does with it depends on what else it is doing and where its people are standing at the time. That is not an excuse. It is the next question.
<!-- OURS — act bridge -->
...
One square metre is a doormat. Nine people. On a doormat.
...
That is what those numbers describe: at the same headcount, a narrow sloping alley is a different kind of place from a wide flat one.
...
There is a second toll figure in circulation, and you may see it if you go looking. A study published in July of this year by the special investigation commission works from a slightly larger set.
<!-- IT-25 ✓ SECONDARY · ⛔-03 -->

The official figure, recorded by the ministry and carried by the reporting, is a hundred and fifty-nine. Until that changes, this film uses it.
...
It was carried out by the Department of Forensic Medicine at Pusan National University School of Medicine, working from death certificates, post-mortem reports and medical records.
<!-- IT-25 ✓ SECONDARY -->
...
A hundred and thirty-seven officers is a real deployment. Spread across a district of bars and restaurants on its busiest night, against an estimated hundred thousand people, most of them working on crime rather than crowds, it is also not very many.
...
A presidential office is more than a building. It is a place people come to be heard outside of.
...
There is one more official document about that night. It came two years before the audit, and it says the opposite of it.
<!-- IT-73, IT-10, IT-12 ✓ VERBATIM -->
...
The court's reasoning was that the emergency response system used to handle the incident was not significantly deficient, given the communication between the ministry, the police and the district office.
<!-- IT-73 ✓ VERBATIM -->

Hold that sentence next to the audit you heard two minutes ago. Not significantly deficient. And: a key factor behind the lack of crowd control officers in Itaewon.
<!-- IT-73, IT-10 ✓ VERBATIM — the film's central juxtaposition -->

Both are official. Both are in writing. They describe the same night. They are two years apart.
<!-- IT-73, IT-10, IT-12 ✓ VERBATIM -->

【Pictures: a hearing room, rows of chairs, a microphone on a table, nobody in frame → a nameplate turned away, blank.】

And in March of this year one more person said it out loud, at a hearing, under his own name.
<!-- IT-89, IT-90 ✓ VERBATIM -->

On the twelfth of March, 2026, the special investigation commission held an investigative hearing in central Seoul. Lee Im-jae — the former station chief, convicted at first instance in September 2024, his appeal suspended since July 2025 — appeared as a witness.
<!-- IT-89, IT-90, IT-30, IT-84 ✓ VERBATIM · ⛔-04 -->

【Quote card. Attributed: "Lee Im-jae, testimony to the 10·29 Itaewon disaster special investigation commission, 12 March 2026".】

He said that if the presidential office had not been moved to Yongsan, he thought the possibility of such a terrible accident would have been considerably lower. He said that with a great deal of manpower dispersed to the presidential office, and fatigue accumulating, response capability had been degraded.
<!-- IT-90 ✓ VERBATIM -->

That is his account, given four years afterwards, by a man with a conviction to appeal against. This film does not adopt it. It reports that he said it — and notes that the government's own audit had already said the first half of it, five months earlier.
<!-- IT-90, IT-10, IT-12 ✓ · ⛔-16, ⛔-08 -->
...
Everything that follows is a first-instance judgment.
...
The court's reasoning: it was either foreseen or it could have been anticipated that a large crowd of people gathering at the slanted alleyway in Itaewon for the 2022 Halloween could cause a serious danger to bodies from pedestrians pushing.
<!-- IT-31 ✓ VERBATIM -->

The court found that he had neglected to establish and implement a safety management plan to prevent it.
<!-- IT-32 ✓ VERBATIM -->

Two others from the same station were sentenced that day: Song Byung-ju, who headed its one-one-two situation room, to two years without labour, and a situation team leader to one year, suspended.
<!-- IT-37 ✓ VERBATIM · ⛔-04 -->

He was acquitted at first instance on the other charges: perjury before the National Assembly, and a false official document.
<!-- IT-38 ✓ VERBATIM · ⛔-04 -->
...
In the court's own language: it was hard to find that she bore a specific and direct duty of care to supplement a safety management plan for Halloween 2022.
<!-- IT-34a ✓ VERBATIM -->
...
Under South Korea's framework law on disaster and safety management, a voluntary event with no organiser did not have to file a safety plan in advance, and it was ambiguous where responsibility on the ground sat.
<!-- IT-26 ✓ SECONDARY -->
...
One thing about the order of those dates, because it is easy to get backwards. The amendment was already law in September 2024, when the court delivered the acquittal. The court was not ignoring it: a criminal court applies the law as it stood on the night, and on that night the sentence did not exist.
...
That is the list. There is nothing clever in it.
<!-- IT-83 ✓ VERBATIM · OURS -->

Every line of it is something somebody has to decide in advance, on paper, with their name on it.
<!-- IT-83, IT-26 ✓ · OURS -->
...
What can be said is that it exists now, that it did not exist then, and that it is written in the language of the night: fire, crowd concentration, personnel, deployment, responsibility.
<!-- IT-83, IT-79 ✓ VERBATIM (PRIMARY) -->

The duty is still missing something. In April of this year a member of the National Assembly proposed adding a penalty — an administrative fine of up to two million won for failing to file one of those plans, and a power to demand that a bad plan be improved.
<!-- IT-82 ✓ SECONDARY -->
...
Three and a half years after a hundred and fifty-nine people died in a street that belonged to nobody, the rule exists — and the penalty for ignoring it was still a bill.
<!-- IT-22, IT-79, IT-82 ✓ -->
...
On the seventh of October, 2024, prosecutors appealed. They appealed against the former station chief, the district office chief, and seven other officials.
<!-- IT-39 ✓ VERBATIM -->

Their grounds, as reported by MBC, were that the defendants were shifting the blame and not seriously reflecting, and that the court had misapprehended the law on the district chief's duty under the disaster and safety act.
<!-- IT-39 ✓ VERBATIM · ⛔-11 -->

【Black. 1.5 s. No picture. This is the film's one designed silence.】

And then, in the summer of 2025, both appeals stopped.
<!-- IT-84, IT-86 ✓ VERBATIM -->

Not concluded. Stopped. By the court itself.
<!-- IT-84, IT-86 ✓ VERBATIM -->

On the fourteenth of July, 2025, the thirteenth criminal division of the Seoul High Court suspended the appeal of the former station chief and the two officers from his one-one-two room.
<!-- IT-84 ✓ VERBATIM · ⛔-04 -->

【Quote card. Attributed: "Seoul High Court, Criminal Division 13, 14 July 2025".】

If what the special committee is doing is re-investigating the facts, the bench said, then it is right to try the case afterwards. There are still many unresolved matters from the disaster, and if there is no integrated resolution and the procedures become fragmented, the harm to the victims is aggravated.
<!-- IT-85 ✓ VERBATIM -->

Six weeks later, on the twenty-eighth of August, a different bench did the same with the district office chief's appeal.
<!-- IT-86 ✓ VERBATIM · ⛔-04 -->

The commission had written to the court on the first of July, asking that the appeals be held until it had deliberated on its findings, which it expected to do the following June.
<!-- IT-87 ✓ VERBATIM -->

Read that again, because it is the strangest sentence in this story. A criminal appeal about a hundred and fifty-nine deaths was paused, by the court, because nobody had yet established what happened.
<!-- IT-84, IT-85, IT-86, IT-22 ✓ · OURS -->

Nearly three years after the night itself.
<!-- IT-07, IT-84 ✓ OURS -->

【Pictures: a lectern from behind → a chamber → a folder marked only with a date.】

The commission is still working, and it is the reason this story is not over.
<!-- IT-43, IT-49 ✓ -->

In January 2024 the President at the time, Yoon Suk Yeol, rejected a special act to investigate the disaster, the government arguing that an opposition-driven committee undermined constitutional principles.
<!-- IT-41 ✓ SECONDARY -->

A commission was established in September 2024, with a name that is itself a sentence: the National Commission for the Investigation of the October 29 Itaewon Disaster and Prevention of Recurrence.
...
At the hearing you heard about a few minutes ago, a survivor testified and police officials traded blame. Kim Kwang-ho — the former Seoul police chief, acquitted at first instance in October 2024 — refused to take the witness oath.
<!-- IT-47, IT-89, IT-91, IT-35 ✓ VERBATIM · ⛔-17, ⛔-04 -->
...
And in June it concluded that it needed another year and three months, to December 2027, and said it would be looking upward — at the chain of command, including the Office of the President.
<!-- IT-49 ✓ SECONDARY -->
...
Somewhere there is a street you walk through without thinking. Ask who decided that it was safe.
<!-- OURS — the ask, unspoken. check_script_craft.SPOKEN_CTA is a hard gate: 45 of 46 Shorts that read a CTA aloud converted zero subscribers. The subscribe/comment ask lives on the ENDCARD and in the description, never in the narration -->

【ENDCARD 9.0 s. The ask is HERE and only here: the card carries the subscribe prompt and the comment prompt as on-screen text, over the last plate. BGM resolves on a musical cadence, not a cut.】
