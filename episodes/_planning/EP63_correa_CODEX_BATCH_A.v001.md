...
| `short186`「Appropriate は辞書で最も見事なごまかし語だ」 | 使うプレート |
|---|---|
...
| `short187`「その金は死に対してではない。待ち時間に対してだ」 | 使うプレート |
|---|---|
...
> 使います。
> **`short187` の縛り:** `$200,000` は「待っている間の苦痛」に対する賠償です。**死に対する対価として
