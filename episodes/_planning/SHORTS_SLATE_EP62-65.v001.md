...
| **Standing question (pinned)** | *Does a relative's signature bind the person who did not sign? The Court left that open.* | *What happened to Brown, Taylor and Marchio after that? The opinion does not say.* | *Who wins when a state court and the Supreme Court disagree about contract law?* |
