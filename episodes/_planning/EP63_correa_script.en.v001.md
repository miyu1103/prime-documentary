# EP63 · CORREA v. HOSPITAL SAN FRANCISCO — SCRIPT v001

**30:00 · target 5,100–5,600 narration words · facts `EP63_correa_FACTS_LEDGER.v001.md` · contract `episodes/PD-2026-063-correa/episode_spec.v001.json`**

Spoken words only below the section headings. `【】` are direction and are not narrated. `⟨HELD⟩` marks a held beat.

**Section keys are the contract's eight, spelled as `section_vocabulary` spells them.**

**Structural locks** — cold open ≤60s cut pre-resolution · re-hook ≤150s · mid reveal 45–60% · primary reveal 65–85%, resolved by 92% · callback 70–90% · reset beat 55–70% · macro loop = the number.
...
A hospital employee did three things. Assigned her a number, forty-seven. Told her to bide her time. And checked her medical insurance card.

An hour passed. Angel telephoned his sister Esther and asked her to take his place. Esther arrived some fifteen minutes later, and Angel left the premises.

⟨HELD⟩
At that very moment, roughly a quarter past two, he heard an attendant calling a patient number for treatment. Twenty-four.

【OST: NUMBER FORTY-SEVEN】

---

## OP (0:55–1:15)

The case is *Correa v. Hospital San Francisco*, decided by the United States Court of Appeals for the First Circuit on the thirty-first of October, 1995.

Nobody at that hospital ever told Carmen Gonzalez no. Nobody discharged her. The number was simply never called.
...
The evidence is conflicted, the court wrote, as to whom she saw and what that person was told about her condition. Angel Correa testified that he implored the receptionist to have someone take care of my mother, because she feels sick and has chest pains. The Hospital disagreed, maintaining that its personnel were told only that Ms. Gonzalez felt dizzy and nauseated.
...
In any event — and this the opinion states as undisputed — a Hospital employee assigned the patient a number, forty-seven, told her to bide her time, and checked her medical insurance card.

That card matters, though not for the reason it looks like it should. Her health plan required her to seek routine treatment at Hospmed, a local clinic, during its business hours. It also allowed her to see any appropriate health-care provider in case of an emergency. She was entitled to be where she was.

Then the waiting.

After approximately one hour, Angel called Esther. Esther came. Angel left, and heard number twenty-four called on his way out.

Now accompanied by her daughter, the opinion says, Ms. Gonzalez maintained her unproductive vigil for an additional forty-five to seventy-five minutes. The Hospital staff continued blithely to ignore her.

Blithely. That is the court's adverb, not ours, and it is the only description of the staff's conduct anywhere in the record.

Add up the clock. She was inside that emergency room for something between two hours and two and a half. No physician saw her in that time.
...
⟨HELD⟩
That is the whole of what the record says about how she died. This film will not add to it.

And here is the thing this episode is most likely to get wrong, so it gets said once, plainly, and early.

The opinion never says the hospital's delay killed her. It never says she would have lived. Her death was attributed to hypovolemic shock, it happened at another facility, and it happened under a physician's care. The federal case that follows is not about her death.

⟨HELD⟩
It is about what happened while she was still sitting there.
...
Probably. Perhaps. Suggesting. The court chose those words with care, and so will this film. Nobody ever proved why the call was made, or by whom, or what was in anybody's mind. What the jury had was a physician's recollection of a call, placed at about the hour a card was checked.

⟨HELD⟩
Keep the call. It comes back.
...
Ms. Gonzalez's three adult children — Angel, Esther and Gloria — and four of her grandchildren, the progeny of her late son, Felix Correa, who had predeceased her. The grandchildren are named in the opinion: Glendalis, Glorimar, Angelis and Sarai. They sued in the United States District Court for the District of Puerto Rico.
...
The case went to the jury on the two EMTALA theories, and the jury returned a series of special written findings.
...
So the hospital appealed. Comprehensively. HSF assigns error in no fewer than eight iterations, the opinion notes: five attacks on the sufficiency of the evidence, one demand for a new trial, and two attacks on the damages.

Eight ways of saying the same thing. None of them worked.
...
First: a participating hospital must afford an appropriate medical screening to all persons who come to its emergency room seeking medical assistance.

Second: if an emergency medical condition exists, the participating hospital must render the services that are necessary to stabilize the patient's condition, unless transferring the patient to another facility is medically indicated and can be accomplished with relative safety.

To add bite to its provisions, EMTALA establishes monetary penalties for noncompliance — not more than fifty thousand dollars for each negligent violation — and authorizes private rights of action against those who transgress its mandates.

Three elements make a claim. One: the hospital is a participating hospital, covered by EMTALA, that operates an emergency department. Two: the patient arrived at the facility seeking treatment. Three: the hospital either did not afford the patient an appropriate screening in order to determine if she had an emergency medical condition, or bade farewell to the patient — whether by turning her away, discharging her, or improvidently transferring her — without first stabilizing the emergency medical condition.

Element three has two doors. This case went through the first one.
...
The court fenced that in immediately, in the same footnote. Civil monetary penalties are imposable irrespective of resulting harm. But the private damages remedy requires a showing of personal harm as a direct result of a participating hospital's violation. It is difficult, the panel said, to imagine a case in which a patient who does not present an emergency medical condition will meet the statute's causation requirement.

Here the question never arose. The plaintiffs alleged she presented an emergency medical condition, the jury so found, and the evidence to that effect was ample.

⟨HELD⟩
So the statute applied — if the hospital did.
...
Not that it had complied. That the law did not reach it. The plaintiffs, it said, had failed to prove the predicate fact: that HSF had accepted the federal government's carrot and agreed to come under the statute.

The court's reply runs nine words. This argument has the shrill ring of desperation.

Here is why. At trial the plaintiffs had introduced into evidence, without objection, HSF's policy statement outlining for its employees and associates how the Hospital intended to ensure compliance with EMTALA in its emergency room. Then, during the defense case, the hospital's own health services administrator testified that he had dutifully instructed his staff regarding the fine points of EMTALA compliance.
...
That figure is the court's, offered without a citation, and it is worth leaving exactly where the court left it. Ninety-nine is not one hundred.

Then the straw man.

The Hospital asserts that it had no obligation to screen because Ms. Gonzalez did not have an emergency medical condition when she reported to its facility. This theory of defense, the panel wrote, is doubly flawed.

The first flaw had already been dealt with. The duty runs to all who enter the hospitals' emergency departments, whether or not they are in the throes of a medical emergency when they arrive.

The second flaw was evidentiary. Angel testified that he told the receptionist his mother was experiencing chest pains. And HSF concedes, the opinion records, that a patient of Ms. Gonzalez's age who suffered from chest pains would be regarded as having an emergency medical condition.
...
Then it went further. Even taking the doctor at her word, the chest pains might well have spurted and later subsided. And even if Ms. Gonzalez had complained only of nausea and dizziness, that symptomatology — as Dr. Rojas herself explained — might well herald the onset of an emergency medical condition in the case of a hypertensive diabetic.
...
Then it quoted the Sixth Circuit, and for one paragraph the opinion stops sounding like a judgment.

Appropriate is one of the most wonderful weasel words in the dictionary, and a great aid to the resolution of disputed issues in the drafting of legislation. Who, after all, can be found to stand up for inappropriate treatment or actions of any sort?

Selya then added his own flourish, borrowed from Emerson: appropriateness, like nature, is a mutable cloud which is always and never the same.

A cloud is not a standard. So the courts had built one, and the First Circuit adopted it.
...
Then the compression. The essence of this requirement is that there be some screening procedure, and that it be administered even-handedly.

Some procedure. Even-handed. That is the whole of the federal duty.
...
Its rules, as explicated in its policy statement, required its emergency room personnel, among other things, promptly to take the vital signs of every patient who visited the facility. To make a written record of all such visits. To treat patients suffering from chest pains as critical cases. And to refer all critical cases to an in-house physician immediately.

Four rules. The hospital wrote them for itself. Now set them beside what the trial produced.

From the evidence adduced at trial, the court wrote — especially Angel Correa's recollections, and the Hospital's utter inability to produce any records anent Ms. Gonzalez's visit.
...
The conclusion is one sentence and every clause of it is a limit. In this case, HSF's delay in attending to the patient was so egregious and lacking in justification as to amount to an effective denial of a screening examination.
...
The panel found that the grays predominate here. That is a modest thing to write while affirming a seven-hundred-thousand-dollar verdict, and it is why this film keeps saying what a jury could have found rather than what happened.

On the new-trial motion the court added two observations. Angel Correa's credibility emerged relatively unscathed from cross-examination, and it could not fault the jury either for crediting his recollection or for concluding that the Hospital denied Ms. Gonzalez any vestige of an appropriate screening. And on coverage, it noticed a silence: the hospital, which could have supplied a foolproof answer from its own records, offered nothing to suggest that it did not welcome Medicare patients.
...
Now the argument this whole episode exists to examine.
...
On its face it was the strongest thing the hospital had. Nobody sent her away. Nobody told her the department was full, or that her plan was wrong. She was in the queue. She left the queue.

The court's answer is four words. This contention is spurious.

Then two reasons, in order.

The first is the telephone call.

According to Dr. Rojas, HSF referred Ms. Gonzalez to Hospmed. And the panel adds a dry aside of its own — we note, as an aside, that HSF called Dr. Rojas as its witness. The hospital's own witness described a call from it, sending its patient elsewhere.
...
That sentence has two halves and the second is the sharper one. If the hospital had arranged for her to be seen at Hospmed, then the hospital is the reason she got up and drove there. The wait it says she abandoned is a wait it had already ended.

The second reason does not depend on the telephone call at all. It is the holding that made this case matter.

Regardless of motive, the court wrote, a complete failure to attend a patient who presents a condition that practically everyone knows may indicate an immediate and acute threat to life can constitute a denial of an appropriate medical screening examination under section 1395dd(a).
...
Much depends upon circumstances. We recognize that an emergency room cannot serve everyone simultaneously.

That caveat is not decoration. Every emergency department runs a queue. The court is not saying that waiting is unlawful. It is saying that in this case, absent any explanation or mitigating circumstances, the jury could rationally conclude that the Hospital's inaction here amounted to a deliberate denial of screening.
...
⟨HELD⟩
Nothing was refused. Everything was withheld.
...
⟨HELD⟩
The court decided none of this on motive. Under its own holding, it did not have to.
...
The hospital's best legal argument on appeal was about damages. Its position was that EMTALA compensates the patient's harm and nothing else — that seven relatives cannot be paid for their own grief under a federal statute about emergency rooms.

The court never decided it.

The chronology is why. The hospital first had the opportunity to assert this defense in its answer to the complaint, and did not. It omitted it from its submissions for the initial scheduling conference. It omitted it from its submissions for the pretrial conference, so the pretrial order, signed by all counsel and entered by the district court, made no mention of it. Its trial brief enumerated three legal issues and this was not among them. It moved for judgment as a matter of law at the close of the plaintiffs' case without raising it, renewed that motion at the close of all the evidence without adding it, and then raised no objection to the verdict forms or the jury instructions that put the relatives' own suffering to the jury.

This was a waiver, pure and simple.

Based on this somber record of inattention, the panel held, HSF forfeited the theory of defense that it now espouses. It gave special weight to the Hospital's boycott of the final pretrial order — an order intended to control the subsequent course of the action, and modifiable only to prevent manifest injustice.

The post-trial motion that finally raised the point got the sentence it deserved. This motion is a classic example of a litigant locking the barn door long after the horse has bolted. A renewed motion under Rule 50(b) is bounded by the earlier one. The movant cannot use such a motion as a vehicle to introduce a legal theory not distinctly articulated in its close-of-evidence motion for a directed verdict.
...
That left excessiveness, reviewed for abuse of discretion. An award must endure unless it is grossly excessive, inordinate, shocking to the conscience of the court, or so high that it would be a denial of justice to permit it to stand.

The evidence behind the five hundred thousand dollars was ordinary and exact. The testimony indicated that the decedent was a matriarchal figure who functioned as the hub of the family circle. Her son Angel lived with her. Her two daughters, Gloria and Esther, resided nearby. Her deceased son's four children — who lost their father a mere five months before their grandmother perished — dwelt in her home for much of their lives. An expert testified that all three of her children suffered depression in the wake of their mother's death, and that the four grandchildren experienced sadness, suffering and the like that would take up to five years to abate.

At trial, HSF neither rebutted this testimony in kind nor effectively impeached it. On appeal it cited a case as authority for a proposition exactly the opposite of what the case holds, without ellipses to signify what it had cut out. The court called the argument both disingenuous and unpersuasive.

It is hard to doubt, the opinion says, that the plaintiffs suffered when the woman described by one witness as the trunk of the family tree was cut down. The sums awarded do not shock or even vellicate our collective conscience.
...
This case, the court added, in which the decedent's travails extended over a period of several hours, is unlike cases involving sudden death in which a decedent's pain and suffering is limited to a few seconds or, at most, a matter of minutes.
...
And it does not say that a wait killed a woman. It says a woman waited, unattended, and that the law had already promised her otherwise.
...
There is no villain in this record. No decision was ever testified to. Nobody was shown to have looked at an insurance card and formed a judgment about the person holding it, and this film has not invented one.
