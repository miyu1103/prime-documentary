...
Two bills came to one house. Pay or face termination. Mary Craft telephoned after a final notice and said she had paid a bill.
...
The Supreme Court affirmed the judgment below and sent the damages question back down undecided. Three Justices dissented, and their account of the same record is printed in the same volume.
...
【motif state 2: the same notice twice, the two names one letter apart】
...
【motif state 3: the notice lies on the table beside the telephone, the handset off its cradle】
...
【the counter at the Division's office: a folded record of payments pushed across it, one hand, no face. Not a motif state】

The Court kept what an employee actually said to her in a footnote. An employee of uncertain authority told Mrs. Craft, apparently without explanation or attempt at investigation, "well, you have to pay on the other" bill.
...
【motif state 4: the final notice open on the kitchen table, the date in the upper half, the lower half white】
...
【motif state 5: a hand leaves a second sheet inside the screen door. That sheet explains how to get the service back】
...
Thirty days of warnings, and one man at the end of them.
...
If there is any dispute concerning the amount due. That is the sentence the first flyer did not contain.
...
Nobody was substantially deprived — except, possibly, the Crafts.
...
【no new state: the same notice, the same fold, lying under the trial court's order】
...
【no new state: the doorstep sheet of state 5 laid beside the notice of state 4, both in frame at once. One page explains how to get the service back. The other half of the other page is empty】
...
And then, inside the reasoning that got there, one more sentence.
...
Broad discretion. The resolution of a disputed bill normally presents a limited factual issue susceptible of informal resolution.
...
Now the dissent in full. Justice Stevens, with the Chief Justice and Justice Rehnquist, dissenting.
...
Three courts, four years, and a record that never agreed with itself — all out of what happened at the other end of that line.

She was given no satisfaction.

⟨HELD⟩

【motif state 8: the same envelope falls into the mailbox again, and the sheet inside it is the state 4 notice — the date in the upper half, the lower half white. NOT the rewritten notice of state 7. No narration.】
