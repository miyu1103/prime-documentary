# EP60 surfside — Codex 画像生成 **バッチD：第1幕・第2幕** v001（40枚・1プロンプト1枚）
...
| Q5 | 崩落・瓦礫・負傷が写っている |
| Q6 | 既存の S001–S110・F001–F024 と実質同じ構図 |
...
*2026-08-01 作成。台本 `EP60_surfside_script.en.v003.md`（6,154語・35.6分）の第1幕・第2幕から積算。事実は `EP60_surfside_FACTS_LEDGER.v001.md`。実写素材で代替できるもの（夜の街314本・法廷144本・工事127本・書類747本・夜明け137本）は除外している。*
