...
**Locks:** 8 keys as spelled · HOOK 8s per `PD_SCREENPLAY_STANDARD.v001.md` §16.5 · mid reveal 45–60% · primary 65–85% · nothing new past 92% · callback 70–90% · reset 55–70% · loop = **the ruled line** — motif state 1 at the head of ACT_1 returning as motif state 7 in the last frame (R222/R223 framing); the HOOK is a flash-forward of state 3 and is not the loop · exactly three ⟨HELD⟩, all after the heavy line · per curiam only · families never merged · no numbers.
