...
| **④ エンディング** | 結末＋シリーズ統合＋次回予告（SPN-0019〜0021） | shotlist ending | 約80〜90秒 |

> **尺の目標＝約12分（11.5〜12.5分）**。台本（ナレ本文）は変えない。本編ナレ＋**フック(約30秒)＋オープニング＋エンディング(約80〜90秒)＋幕間の“ひと呼吸”**（山場 SPN-0012 判決リビール後の余韻、act転換の短い間）で約12分に寄せる。間延びさせず密度で稼ぐ（カット切替は§2基準=約4.5秒を維持）。
...
- **見やすさ（VIDEO_RULES §13・数値）**: 文字 ≈48〜60px・本文太字・**白文字＋濃い縁取り/影＋半透明黒帯(不透明度~55〜70%)**・最大2行・中央寄せ・下部安全帯・1〜2行ずつ送り（読み切れる表示時間＝高速点滅切替しない）。
