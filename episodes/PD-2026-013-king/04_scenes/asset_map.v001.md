# 素材マップ — PD-2026-013-king

各場面（スパン）に、どの映像・写真を使うか／Codexが何を生成するかの一覧。タイトル「The Police Can Take Your DNA When They Arrest You」。
...
- ナレ: 「You get arrested. Maybe it is serious, maybe it is a mistake — it…」
- テロップ: Arrested — not convicted. They take your DNA.
- 使う素材: 🖼 scotus_gavel.jpg — judge's gavel、🖼 us_constitution_p1.jpg — US Constitution page 1、🖼 bill_of_rights.jpg — Bill of Rights parchment、🖼 us_dollar_bill.jpg — US one-dollar bill、🖼 rbg_scotus_portrait.jpg — RBG official portrait

## SPN-0002  [opening]  〜46秒
- 担当: 🎨 Codexが画像を生成（下の写真は“仮置き”。AIで作って差しかえる）
- ナレ: 「The Fourth Amendment is supposed to stop the government from searching you for evidence…」
- テロップ: Identification — or a search?
- 仮置き写真（AIで生成して差しかえ）: 🖼 roberts_scotus_portrait.jpg — CJ Roberts official portrait、🖼 pexels_smartphone_hand.jpg — hand holding smartphone、🖼 pexels_money_handover.jpg — hands exchanging dollars、🖼 pexels_tow_truck.jpg — car on flatbed tow truck、🖼 pexels_house_for_sale.jpg — suburban house for sale、🖼 pexels_signing_contract.jpg — signing a contract、🖼 pexels_police_car.jpg — police car on street、🖼 pexels_i_14766052.jpg — courtroom

## SPN-0003  [act1]  〜16秒
- 担当: 🔤 文字グラフィック（Remotionのテロップ。素材不要）
- ナレ: 「In 2009, a man named Alonzo King is arrested in Maryland. The charge is…」
- テロップ: Maryland, 2009 — arrested for assault
- 使う素材: 🖼 pexels_house_for_sale.jpg — suburban house for sale、🖼 pexels_i_37730973.jpg — courtroom、🖼 pixabay_i_3194994.jpg — courtroom

## SPN-0004  [act1]  〜18秒
- 担当: 🎨 Codexが画像を生成（下の写真は“仮置き”。AIで作って差しかえる）
- ナレ: 「During booking, under a Maryland law, the police take a cheek swab and record…」
- テロップ: The swab was NOT the reason for arrest
- 仮置き写真（AIで生成して差しかえ）: 🖼 pixabay_i_565914.jpg — courtroom、🖼 pexels_i_6077447.jpg — gavel、🖼 pexels_i_37732186.jpg — gavel、🖼 pixabay_i_2492011.jpg — gavel

## SPN-0005  [act1]  〜19秒
- 担当: 🔤 文字グラフィック（Remotionのテロップ。素材不要）
- ナレ: 「His DNA profile goes into the database. And there, it matches genetic evidence left…」
- テロップ: Match: an unsolved 2003 case
...
## SPN-0008  [act2]  〜12秒
- 担当: 🎨 Codexが画像を生成（下の写真は“仮置き”。AIで作って差しかえる）
- ナレ: 「To decide it, the Court had to answer a deceptively simple question: what is…」
