...
import {LINE_WINDOWS, SHORT271_CAPTIONS, SHORT271_TOTAL_SEC} from './short271_timing';

/**
 * short271 — A state wildlife officer walked onto ninety-three private acres, cut a branch off a tree and mounted a camera on it. Nobody had to tell the man who farms it.
 * Episode PD-2026-066-openfields.  Type ?.
 *
 * AVOIDS: No claim the officer needed a federal warrant; no claim Tennessee struck the statute down; no acreage other than the approximately ninety-three in the record; no count of cameras, entries or days.
 * LEAVES FOR THE LONG-FORM: If the land is yours and the Fourth Amendment does not reach it, what does?
 *
...
const CUTS: Cut[] = [
  {line: 'L1', id: 'p01', src: 'shorts/short271/short271_01.png', kind: 'image', motion: 'parallax', fast: true},   // L037 approved episode plate
  {line: 'L1', id: 'p02', src: 'shorts/short271/short271_02.png', kind: 'image', motion: 'kenburns', fast: true},   // L019 approved episode plate
  {line: 'L2', id: 'p03', src: 'shorts/short271/short271_03.png', kind: 'image', motion: 'pushin', fast: true},   // L020 approved episode plate
  {line: 'L3', id: 'p04', src: 'shorts/short271/short271_04.png', kind: 'image', motion: 'parallax'},   // L021 approved episode plate
  {line: 'L4', id: 'p05', src: 'shorts/short271/short271_05.png', kind: 'image', motion: 'kenburns'},   // L007 approved episode plate
  {line: 'L4', id: 'p06', src: 'shorts/short271/short271_06.png', kind: 'image', motion: 'pushin'},   // L008 approved episode plate
  {line: 'L5', id: 'p07', src: 'shorts/short271/short271_07.png', kind: 'image', motion: 'parallax'},   // L009 approved episode plate
...
const buildBeats = (): ShortBeat[] => {
  ...
  LINE_WINDOWS.forEach((win, i) => {
    ...
    const end = i + 1 < LINE_WINDOWS.length ? LINE_WINDOWS[i + 1].start : SHORT271_TOTAL_SEC;
...
export const SHORT271: ShortData = {
  shortId: 'short271',
  episodeId: 'PD-2026-066-openfields',
  durationSec: SHORT271_TOTAL_SEC,
  narrationSrc: 'shorts/short271/audio/short271_final_mix_v002_en_us.mp3',
  captions: SHORT271_CAPTIONS,
  bgmSrc: null,
  ...
  ctaFadeOutSec: 0.8,
  beats: buildBeats(),
  // Mid-roll kinetic type, built in After Effects (runs/ae_jobs/short271.json) and installed
  ...
  kineticBeats: [
    {src: 'shorts/short271/short271_kin_ninety_three.webm', atSec: 7.19, durSec: 2.0, phrase: "93 ACRES"},
    {src: 'shorts/short271/short271_kin_no_notice.webm', atSec: 20.71, durSec: 2.0, phrase: "NO NOTICE"},
  ],
};
