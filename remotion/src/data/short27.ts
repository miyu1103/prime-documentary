...
import {LINE_WINDOWS, SHORT27_CAPTIONS, SHORT27_TOTAL_SEC} from './short27_timing';
...
const img = (n: string) => `shorts/short27/short27_${n}.png`;
...
const buildBeats = (): ShortBeat[] => {
  ...
  LINE_WINDOWS.forEach((win, i) => {
    ...
    const spanEnd = i + 1 < LINE_WINDOWS.length ? LINE_WINDOWS[i + 1].start : SHORT27_TOTAL_SEC;
...
export const SHORT27: ShortData = {
  shortId: 'short27',
  episodeId: 'PD-2026-027-rodriguez',
  durationSec: SHORT27_TOTAL_SEC,
  narrationSrc: 'shorts/short27/audio/short27_final_mix_v002_en_us.mp3',
  captions: SHORT27_CAPTIONS,
  bgmSrc: null,
