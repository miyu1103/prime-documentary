...
export type TekohThumbConcept = {
  id: string;
  headline: string;
  hero: string;
  accentWord?: string;
  badge?: string;
  mode: 'door' | 'vote' | 'shield';
};

export const TEKOH_THUMBS: TekohThumbConcept[] = [
  {id: '01', headline: '6-3 ONE DOOR', hero: 'tekoh/img/S44.png', accentWord: '6-3', badge: 'EXCLUSION STAYS OPEN', mode: 'vote'},
  {id: '02', headline: 'THE WARNING MISSED', hero: 'tekoh/img/S04.png', accentWord: 'MISSED', badge: 'VEGA v. TEKOH', mode: 'door'},
  {id: '03', headline: 'RIGHT NOT REMEDY', hero: 'tekoh/img/S45.png', accentWord: 'REMEDY', badge: 'MIRANDA STANDS', mode: 'shield'},
];
...
export const TekohThumbnail: React.FC<{concept: TekohThumbConcept}> = ({concept}) => {
