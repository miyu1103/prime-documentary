#!/usr/bin/env python3
"""Build PD-2026-007 Riley final v003 local package render.
...
VISUAL = EPM / "08_edit" / "riley_visual_v003.mp4"
OUT_MEDIA = EPM / "08_edit" / "riley_final_v003.mp4"
...
YOUTUBE_META = EPDIR / "09_package" / "youtube_meta.v003.json"
...
def render_visual_if_needed() -> None:
    ...
    run_in([
        ...
        "--overwrite",
    ], "render revised RileyPremium visual v003", cwd=REMOTION)
...
def mux_final() -> None:
    ...
    run([
        ...
        "+faststart",
        OUT_MEDIA,
    ], "mux Riley final v003 render with ElevenLabs VO, library music, and sidecar captions")
...
def write_package_and_qc(narr_dur: float) -> dict:
    ...
    q = {
        ...
        "episode_id": EP,
        "revision": "v003",
        "render": "artifact://episodes/PD-2026-007-riley/08_edit/riley_final_v003.mp4",
        ...
        "captions_sidecar": "artifact://episodes/PD-2026-007-riley/08_edit/captions.final.v003.srt",
    ...
    meta = {
        ...
        "video": "artifact://episodes/PD-2026-007-riley/08_edit/riley_final_v003.mp4",
        ...
        "pre_publish_checks": {
            ...
            "final_qc": "episodes/PD-2026-007-riley/08_edit/renders/final.v003.qc.json",
            "synthetic_content_disclosure_required": True,
