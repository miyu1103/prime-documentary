#!/usr/bin/env python
"""Stage EP44 Tekoh generated media into remotion/public without overwriting."""
...
AI = Path("E:/pd-media/assets/ai/tekoh")
MOTION = Path("E:/pd-media/assets/ai_video/tekoh")
