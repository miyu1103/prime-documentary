#!/usr/bin/env python3
"""EP47 atwater: composite the rendered After-Effects hero cards onto the finished BGM film
...
Usage: python scripts/composite_atwater_hero.py <bgm_in.mp4> <out_v001_ae.mp4>
"""
...
BEATS = ROOT / "episodes" / "PD-2026-047-atwater" / "08_edit" / "ae_hero" / "beats.json"
...
def main() -> int:
    if len(sys.argv) != 3:
        print("Usage: composite_atwater_hero.py <bgm_in.mp4> <out_v001_ae.mp4>", file=sys.stderr); return 2
