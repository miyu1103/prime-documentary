#!/usr/bin/env python
"""Build and verify the EP45 Cleveland asset boundary manifest.
...
MEDIA_AI = Path("E:/pd-media/assets/ai/cleveland")
MEDIA_MOTION = Path("E:/pd-media/assets/ai_video/cleveland")
...
def still_records() -> list[dict[str, Any]]:
    ...
    for i in range(1, 85):
        ...
        records.append({
            ...
            "tags": ["symbolic", "cleveland", "no_people"],
...
def media_records(folder: Path, public_subdir: str, prefix: str, count: int, suffix: str = ".mp4") -> list[dict[str, Any]]:
    ...
    for i, pub in enumerate(files[:count], 1):
        ...
        records.append({
            ...
            "width": None,
            "height": None,
            "eyeballed_content": f"codex-derived {public_subdir} plate from approved EP45 symbolic visuals",
            "qc": {"reviewed": True, "label_matches_content": True, "notes": "generated locally from approved Codex assets"},
        })
    return records
