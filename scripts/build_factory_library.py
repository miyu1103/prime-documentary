...
CATEGORIES: dict[str, tuple[str, list[str]]] = {
    "backgrounds": ("both", [
        ...
        "person crying silhouette window", "hands clasped praying", "person reading a letter",
        "empty chair in spotlight grief", "lawyer and client meeting silhouette", "doctor consulting patient silhouette",
        "teacher in empty classroom", "factory workers silhouette", "construction worker silhouette",
        "farmer in field at dawn", "homeless person on street night", "person in wheelchair silhouette",
        "elderly person alone at window", "child looking out rainy window", "crowd of commuters silhouette",
        "lone businessman walking corridor", "two people arguing silhouette", "person signing document hand",
        "old faded photograph macro", "wedding ring on table", "military dog tags", "broken chain link macro",
        "key turning in lock", "open door bright light", "window blinds shadow stripes", "hourglass sand falling",
        "brass compass on map", "vintage globe desk", "world map with pins and string", "red rotary telephone",
        "vintage film camera", "film reel projector", "vinyl record spinning", "fountain pen signature",
        "stack of letters with ribbon", "pocket watch macro", "retro diner interior", "motel neon sign night",
        "gas station at night", "warehouse loading dock", "shipping containers at port", "oil refinery at night",
        "wind turbines in field", "solar panel farm", "hydro dam water release", "factory smokestacks dusk",
        "construction crane against sky", "skyscraper looking up", "graffiti alley at night", "highway underpass",
        "rooftop city skyline night", "subway train motion blur", "airport runway at night", "harbor cranes dusk",
        "deep ocean dark", "underwater god rays", "northern lights aurora", "milky way night sky",
        "lava flow glowing", "blue ice cave", "sand dunes desert", "grand canyon vista", "waterfall long exposure",
        "frozen lake snow", "volcano eruption", "storm clouds lightning", "wildfire smoke sky",
        "cracked dry earth drought", "misty mountain valley", "field of wheat in wind",
        "ai neural network glowing", "holographic data interface", "robot arm assembly line",
        "server room red alert", "biometric face scan grid", "encryption code green", "neural network nodes blue",
        "data center corridor", "circuit traces macro", "city data overlay map", "drone flying at dusk",
        "police lineup wall", "vintage wanted poster", "ankle monitor", "prison gate closing", "old ledger book",
        "audit documents stack", "tax forms on desk", "stock exchange crowd", "vault door spinning lock",
        "old cash register", "gold coins pile", "newspaper stock crash headline", "bread line vintage depression",
    ]),
    "light_assets": ("both", [
        ...
        "aurora light curtain", "underwater caustics light", "stadium floodlights night", "car light trails long exposure",
        "fireworks in dark sky", "searchlight beam sky", "campfire glow night", "street lamp in fog",
    ]),
    "particle_assets": ("both", [
        ...
        "fireflies in forest", "gentle snow falling night", "volcanic ash falling", "sea foam spray",
        "pollen drifting in light", "dandelion seeds wind", "rain drops on dark water", "floating lanterns night",
    ]),
    "vfx_overlays": ("both", [
        ...
        "lava glow with smoke", "underwater bubbles rising", "sandstorm wall approaching", "ink swirl in water black",
        "fireworks smoke trails", "geyser steam burst", "molten metal pour", "dry ice fog floor",
    ]),
