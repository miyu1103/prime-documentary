#!/usr/bin/env python3
"""EP41 thompson: replace the baked narration with the authoritative master VO and add a
...
Usage: python scripts/build_thompson_bgm.py <render_in.mp4> <final_out.mp4>
"""
...
IDX = ROOT / "episodes" / "PD-2026-041-thompson" / "06_audio" / "narration_index.v001.json"
VO = Path(r"H:/pd-media/episodes/PD-2026-041-thompson/06_voice/master/vc_master_v001.mp3")
...
def main() -> int:
    ...
    a1, a2, a3, a4 = fs("ACT_1"), fs("ACT_2"), fs("ACT_3"), fs("ACT_4")
    ...
    bgm = [
        ...
        (MUS / "reveal/mus_20260614_reveal_verdict_at_dawn_v1.mp3", a3, mid34, 0.21),
        (MUS / "tension_build/mus_20260614_tension_build_courtroom_horizon_v2.mp3", mid34, a4, 0.20),
        (MUS / "somber/mus_20260614_somber_ledger_of_ash_v2.mp3", a4, vo_end - 42, 0.18),
        (MUS / "reveal/mus_20260614_reveal_verdict_at_dawn_v2.mp3", vo_end - 42, vo_end, 0.22),
    ...
    work = out.parent / "_thompson_bgm_pre.wav"
