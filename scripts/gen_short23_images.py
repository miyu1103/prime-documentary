...
Output : H:/pd-media/assets/ai/shorts/short23/short23_01.png .. _07.png + short23_thumb.png
...
OUT = r"H:/pd-media/assets/ai/shorts/short23"
...
SHOTS = [
    ("short23_01", "A vast dark digital library of glowing document icons stacked into towering shelves of light behind a locked gate of electric-blue light, one small key resting nearby, knowledge behind a paywall, no faces, no readable text"),
    ("short23_02", "A single open laptop glowing softly on a desk in a quiet dark room, thin lines of blue light rising from the screen, an empty chair implying the young coder, no face, no readable screen"),
    ("short23_03", "An abstract web of glowing electric-blue nodes linking floating document shapes into an open shared network, the idea of free knowledge, luminous on deep navy, no text"),
    ("short23_04", "A calm university archive corridor at night, endless tall shelves receding into darkness, one cold shaft of light on the floor, dignified and empty, no people, no readable spines"),
    ("short23_05", "A dropped set of unused steel handcuffs lying open beside a single plain sealed cream envelope on a cold dark surface, symbolic of charges no one asked for, restrained, no readable text"),
    ("short23_06", "A balance scale tipped hard, a towering stack of plain closed blank books on one heavy pan versus one small warm figure of light on the other, disproportion made visual, deep navy, no titles, no text"),
    ("short23_07", "A single quiet candle-soft point of warm gold light glowing in deep navy darkness, a respectful memorial mood, pure gentle light only, no figure, no text, generous empty space at top for a caption"),
    ("short23_thumb", "A locked ornate gate of glowing electric-blue document icons with one small key resting before it, deep navy and blue, iconic key visual, no faces, no legible text"),
]
...
def gen(stem, core, force, no_hr):
    ...
    if os.path.exists(out_path) and not force:
        ...
        return
    seed = 230000 + int(stem.split("_")[1].replace("thumb", "99"))
    payload = {
...
def main():
    ...
    print("[all ] short23 image generation finished", flush=True)
