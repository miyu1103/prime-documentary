#!/usr/bin/env python3
"""EP43 caniglia: composite the rendered After-Effects hero cards onto the finished BGM film
...
Usage: python scripts/composite_caniglia_hero.py <bgm_in.mp4> <out_v002_ae.mp4>
"""
...
BEATS = ROOT / "episodes" / "PD-2026-043-caniglia" / "08_edit" / "ae_hero" / "beats.json"
...
def main() -> int:
    if len(sys.argv) != 3:
        print("Usage: composite_caniglia_hero.py <bgm_in.mp4> <out_v002_ae.mp4>", file=sys.stderr); return 2
