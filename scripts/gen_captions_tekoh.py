#!/usr/bin/env python
"""Generate EP44 Tekoh captions from narration_index text.
...
def main() -> int:
    ...
    ap.add_argument("--narr", type=Path, required=False, default=ROOT / "episodes" / EP / "06_audio" / "narration_index.v001.json")
