...
OUT = r"H:/pd-media/assets/ai/shorts/short34"
...
# EP34 Rolin / airport cash civil forfeiture — airport / cash / travel lane (distinct from EP33 home, EP35 bank).
# text-free symbolic, no real-person likeness, no readable text / signage / denominations / seals.
SHOTS = [
    ("short34_01", "A cold airport security inspection area at night, an anonymous traveler's dark carry-on bag alone on a stainless steel scanner belt, hard clinical overhead light, no people, no faces, no signage, no readable text, no logos"),
    ("short34_02", "A worn rubber-banded bundle of blank unmarked paper currency sitting on a cold stainless steel inspection table under a harsh interrogation light, deep shadow around it, no denominations, no faces on the bills, no readable text, no logos"),
    ("short34_03", "An empty airport departure corridor at night, a single lone rolling suitcase standing abandoned, cold blue glow from blank overhead displays, no readable text, no people, no signage"),
    ("short34_04", "An anonymous gloved hand sliding a sealed clear evidence bag full of blank cash across a cold metal table, tight dramatic light, no faces, no labels, no readable text, no logos"),
    ("short34_05", "A single rubber-banded bundle of blank cash isolated in a hard spotlight inside a dark void, ringed by faint cordon lines, symbolic 'the money on trial', no text, no numerals, no logos"),
    ("short34_06", "An abstract marble colonnade evoking a federal courthouse at dusk, tall columns and a single solemn shaft of light, hushed and monumental, no signage, no words, no seals, no statues of real people"),
    ("short34_07", "An open empty human hand receiving a bundle of blank cash sliding back across a table under warm restored light, a sense of return, generous dark negative space, no faces, no readable text, no logos"),
    ("short34_thumb", "A rubber-banded bundle of blank cash caught inside a cold electric-blue airport scanner beam, high-contrast iconic key visual, deep navy background, muted-gold edge, no faces, no denominations, no legible text, no logos"),
]
...
def gen(stem, core, force, no_hr):
    ...
    if os.path.exists(out_path) and not force:
        ...
        return
    seed = 340000 + int(stem.split("_")[1].replace("thumb", "99"))
    payload = {
...
def main():
    ...
    print("[all ] short34 image generation finished", flush=True)
