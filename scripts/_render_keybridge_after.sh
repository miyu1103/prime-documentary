...
# EP77 keybridge, held out of the first queue until its 17 regenerated clips had been read
# against their plates. They have been: 0 of 17 invent a person, 0 of 17 resolve a face,
# and the three largest transient bumps collapsed (H017 6.74->0.00, H066 5.71->0.00,
# H083 4.69->0.00). H123 and H052 were re-checked by hand at the exact frames where the
# faces used to be: an empty switchgear room and an empty lock gate.
for job in "keybridge Ep77KeyBridge 77"; do
