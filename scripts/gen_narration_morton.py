...
SCRIPT_SRC = ROOT / "episodes" / "_planning" / "EP52_morton_script.en.v001.md"
SOURCE_SCRIPT_REL = "episodes/_planning/EP52_morton_script.en.v001.md"
...
DELIVERY_BY_SECTION = {
    "HOOK": "intense",    # cold open: the 3-year-old naming a "monster", the burial of evidence
    "OP": "building",     # spoken thesis + open loop (after the silent gold BrandOpening card)
    "ACT_1": "building",  # THE HUSBAND DID IT: the murder, Michael the only suspect
    "ACT_2": "building",  # THE TRIAL: the thin case, withheld evidence, conviction
    "ACT_3": "building",  # TWENTY-FIVE YEARS: prison, the long fight for the bandana
    "ACT_4": "building",  # WHAT THE BANDANA KNEW: the payoff cascade (DNA/Norwood/Baker/Anderson)
    "ENDING": "calm",     # the truth lands last
}
...
# match wins). EP52 headings are `## COLD OPEN ...`, `## OPENING ...`, `## ACT I — ...` ...
# `## ACT IV — ...`, `## ENDING ...` (Roman numerals, no brackets). Longer Roman numerals
# FIRST so ACT IV/III/II don't get shadowed by ACT I.
SECTION_HEADINGS = [
...
# EP52's post-ENDING sections are `## RUNTIME / WORD COUNT` and `## SELF-CHECK — PASS 1/2/3`.
STOP_HEADINGS = [
