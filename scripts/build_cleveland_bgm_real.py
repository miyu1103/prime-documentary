#!/usr/bin/env python3
"""EP43 cleveland: replace the baked narration with the authoritative master VO and add a
...
Usage: python scripts/build_cleveland_bgm_real.py <render_in.mp4> <final_out.mp4>
"""
...
VO = Path(r"E:/pd-media/episodes/PD-2026-045-cleveland/06_voice/master/vc_master_v001.mp3")
...
def main() -> int:
    ...
    # EP43 cleveland is a 3-act film (HOOK/OP/ACT_1/ACT_2/ACT_3/ENDING) -- no ACT_4.
