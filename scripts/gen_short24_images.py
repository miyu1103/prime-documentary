...
Output : H:/pd-media/assets/ai/shorts/short24/short24_01.png .. _07.png + short24_thumb.png
...
OUT = r"H:/pd-media/assets/ai/shorts/short24"
...
SHOTS = [
    ("short24_01", "A vintage reel-to-reel wiretap recorder turning in shadow, a single red record glow, headphones nearby, surveillance noir, no faces, no text"),
    ("short24_02", "A cold glass hedge-fund tower at dusk, faint lit windows implying scale of money, power and wealth, no logos, deep navy and gold"),
    ("short24_03", "Three faceless corporate silhouettes in different office settings passing a glowing sliver of paper hand to hand, insiders, no faces, no company marks"),
    ("short24_04", "A telephone handset with a visible glowing sound-wave leaking from it, the crime in his own voice, electric blue on black, no text"),
    ("short24_05", "A solemn jury box seen from the bench side in a shaft of cold light, the moment of the verdict, no people, dignified"),
    ("short24_06", "A gavel resting on a dark bench in a cold blue shaft of light, the weight of an eleven-year sentence, no readable text"),
    ("short24_07", "A single empty boardroom chair at the head of a long dark table under one light, the secrets came from the very top, no faces, no logos"),
    ("short24_thumb", "A vintage reel-to-reel wiretap recorder turning with a red record glow over a dark night city skyline, surveillance noir key visual, electric blue and black, no legible text"),
]
...
def gen(stem, core, force, no_hr):
    ...
    if os.path.exists(out_path) and not force:
        ...
        return
    seed = 240000 + int(stem.split("_")[1].replace("thumb", "99"))
    payload = {
...
def main():
    ...
    print("[all ] short24 image generation finished", flush=True)
