...
Output : H:/pd-media/assets/ai/shorts/short30/short30_01.png .. _07.png + short30_thumb.png
...
OUT = r"H:/pd-media/assets/ai/shorts/short30"
...
SHOTS = [
    ("short30_01", "A backlit police lineup rendered as five faceless anonymous silhouettes standing in a row behind a cold measuring grid, deep navy, one figure faintly haloed, no faces, no readable text"),
    ("short30_02", "A sketch artist's pencil resting on an unfinished featureless composite face on paper, warm desk lamp against navy dark, memory as a rough sketch, no recognizable person, no readable words"),
    ("short30_03", "One anonymous silhouette photo-card lifting out of a six-frame array and reappearing inside a backlit live-lineup row, the same faceless figure in both places, an electric-blue link line between them, no faces, no text"),
    ("short30_04", "A single tentative pencil outline of a face traced over and over until it hardens into one bold confident line, a motion-graphic of a guess turning into certainty, navy field, no real likeness, no letters"),
    ("short30_05", "A luminous DNA double helix of electric-blue light beside two banding columns, one clearly not aligning and one snapping into perfect alignment, cold forensic truth, no faces, no readable labels"),
    ("short30_06", "Two anonymous hands reaching across a small table and almost meeting in warm golden light against soft navy, reconciliation and forgiveness, faces unseen, tender and quiet, no text"),
    ("short30_07", "Two long shadows walking side by side into a warm bloom of light down a corridor, partners not enemies, generous empty negative space, no faces, no logos, no text"),
    ("short30_thumb", "A backlit faceless police lineup with one silhouette softly haloed and a thin electric-blue DNA helix crossing the frame, deep navy, iconic key visual, no faces, no legible text"),
]
...
def gen(stem, core, force, no_hr):
    ...
    if os.path.exists(out_path) and not force:
        ...
        return
    seed = 300000 + int(stem.split("_")[1].replace("thumb", "99"))
    payload = {
...
def main():
    ...
    print("[all ] short30 image generation finished", flush=True)
