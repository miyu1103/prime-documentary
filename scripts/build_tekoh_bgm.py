#!/usr/bin/env python3
"""EP44 tekoh: replace the baked narration with the authoritative master VO and add a
...
Usage: python scripts/build_tekoh_bgm.py <render_in.mp4> <final_out.mp4>
"""
...
def main() -> int:
    ...
    # EP44 tekoh is a 3-act film (HOOK/OP/ACT_1/ACT_2/ACT_3/ENDING) -- no ACT_4.
