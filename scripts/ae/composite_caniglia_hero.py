#!/usr/bin/env python
"""Composite EP43 Caniglia AE hero cards over a base render."""
...
def main() -> int:
    ...
    base = args.base or (EDIT / "_dryrun" / "caniglia_final_bgm.v002.mp4" if args.dryrun else EDIT / "caniglia_final_bgm.v002.mp4")
    out = args.out or (EDIT / "_dryrun" / "caniglia_final_bgm.v003_ae.mp4" if args.dryrun else EDIT / "caniglia_final_bgm.v003_ae.mp4")
