#!/usr/bin/env python3
"""EP43 caniglia: replace the baked narration with the authoritative master VO and add a
...
Usage: python scripts/build_caniglia_bgm_real.py <render_in.mp4> <final_out.mp4>
"""
...
IDX = ROOT / "episodes" / "PD-2026-043-caniglia" / "06_audio" / "narration_index.v001.json"
VO = Path(r"H:/pd-media/episodes/PD-2026-043-caniglia/06_voice/master/vc_master_v001.mp3")
...
def main() -> int:
    ...
    # EP43 caniglia is a 3-act film (HOOK/OP/ACT_1/ACT_2/ACT_3/ENDING) -- no ACT_4.
    ...
    work = out.parent / "_caniglia_bgm_pre.wav"
