#!/usr/bin/env python
"""Technical QC for EP45 Cleveland stills."""
...
def main() -> int:
    ...
    print(("PASS" if not errors else "FAIL") + f" cleveland_stills_resolution checked={len([x for x in data.get('stills', []) if x.get('role') == 'body'])}")
