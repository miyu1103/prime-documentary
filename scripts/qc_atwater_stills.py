#!/usr/bin/env python
"""Technical QC for EP47 Atwater image assets."""
...
PUBLIC_DIR = ROOT / "remotion" / "public" / "atwater" / "img"
...
def main() -> int:
    ...
    print(f"{'PASS' if not errors else 'FAIL'} atwater_stills_qc checked={len(expected_ids())} errors={len(errors)}")
