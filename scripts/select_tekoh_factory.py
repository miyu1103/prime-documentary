#!/usr/bin/env python
"""EP44 factory-footage verification helpers."""
...
PRIOR_PUBLIC = [ROOT / "remotion" / "public" / s / "factory" for s in ("frazier", "lech", "thompson", "young", "caniglia")]
PRIOR_SELECTED = [
    ROOT / "runs" / "qc" / "young_factory_selected.v001.json",
    ROOT / "runs" / "qc" / "caniglia_factory_selected.v001.json",
]
