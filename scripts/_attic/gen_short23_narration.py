...
LINES: list[tuple[str, str, str]] = [
    ("L1", "intense", "The website he took from didn't even want him charged."),
    ("L2", "building", "Aaron Swartz was a programming prodigy. As a teenager he co-authored the RSS specification and helped build Creative Commons, believing knowledge paid for by the public should belong to the public."),
    ("L3", "building", "Over MIT's open network, he downloaded about four point eight million scholarly articles — most of the JSTOR archive. JSTOR settled and said it did not want him prosecuted. MIT stayed neutral. Prosecutors charged him anyway — four counts, then thirteen."),
    ("L4", "intense", "On paper the charges stacked to a theoretical maximum of thirty-five years; but prosecutors signaled a plea of about six months, and legal scholars said that headline wildly overstated what he really faced. Aaron Swartz died by suicide on January 11, 2013, at age 26. His family said the prosecution's overreach contributed to his death."),
    ("L5", "calm", "If you're struggling, you can call or text 988, the Suicide and Crisis Lifeline. Watch the full story on the channel."),
]
...
def main() -> int:
    ...
    master = media_root() / "episodes" / EP / "06_voice" / "master" / "short23_vc_master_en_us_v002.mp3"
    master.parent.mkdir(parents=True, exist_ok=True)
    subprocess.run(["ffmpeg", "-y", "-f", "concat", "-safe", "0", "-i", str(concat),
                    "-c:a", "libmp3lame", "-b:a", "192k", str(master)], check=True, capture_output=True)

    idx = ROOT / "episodes" / EP / "06_audio" / "short23_narration_index.v002.en_us.json"
