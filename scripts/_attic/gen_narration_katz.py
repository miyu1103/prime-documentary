#!/usr/bin/env python3
"""Generate PD-2026-025 Kyllo narration with the channel voice.

Paid ElevenLabs API call. Owner approved the script gate (APR-0001) 2026-07-04.
Idempotent: existing non-empty chunks are skipped.
Same per-episode pattern as scripts/gen_narration_king.py (only EP differs).
"""
