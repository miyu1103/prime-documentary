#!/usr/bin/env python3
"""Generate SHORT #13 (arrest DNA collection / Maryland v. King) vertical-short narration.
...
# (line_id, delivery, spoken_text)  — US-market adaptation of SHORTS_EP9-15.md SHORT #13.
LINES: list[tuple[str, str, str]] = [
    ("L1", "intense", "Get arrested, even by mistake, and police can take your DNA, and keep it."),
    ("L2", "building", "In 2009, a man was arrested for assault. At booking, they swabbed the inside of his cheek."),
    ("L3", "building", "That sample matched an unsolved case from years earlier. He was convicted of it. It looks like justice, but here's the catch."),
    ("L4", "intense", "In 2013, the Supreme Court called it legal, just like fingerprints. But four justices, left and right, dissented: it's a search of your body for crimes you're not even suspected of."),
...
def main() -> int:
    ...
    master = media_root() / "episodes" / EP / "06_voice" / "master" / "short13_vc_master_en_us_v002.mp3"
    master.parent.mkdir(parents=True, exist_ok=True)
    subprocess.run(["ffmpeg", "-y", "-f", "concat", "-safe", "0", "-i", str(concat),
                    "-c:a", "libmp3lame", "-b:a", "192k", str(master)], check=True, capture_output=True)

    idx = ROOT / "episodes" / EP / "06_audio" / "short13_narration_index.v002.en_us.json"
