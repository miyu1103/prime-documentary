#!/usr/bin/env python3
"""Generate SHORT #14 (hot-pursuit home entry / Lange v. California) vertical-short narration.
...
# (line_id, delivery, spoken_text)  — US-market adaptation of SHORTS_EP9-15.md SHORT #14.
LINES: list[tuple[str, str, str]] = [
    ("L1", "intense", "An officer chases you over something minor, and you step inside your home. Can he follow you in?"),
    ("L2", "building", "One man was just playing his music too loud. An officer flipped on his lights, and the man pulled into his own garage."),
    ("L3", "building", "The officer stuck his foot under the closing garage door, and walked right in."),
    ("L4", "intense", "In 2021, the Supreme Court said no: chasing a minor offense, by itself, does not automatically let police enter your home. They need a warrant, or a real emergency. Your home is still the hardest place for the state to enter."),
...
def main() -> int:
    ...
    master = media_root() / "episodes" / EP / "06_voice" / "master" / "short14_vc_master_en_us_v002.mp3"
    master.parent.mkdir(parents=True, exist_ok=True)
    subprocess.run(["ffmpeg", "-y", "-f", "concat", "-safe", "0", "-i", str(concat),
                    "-c:a", "libmp3lame", "-b:a", "192k", str(master)], check=True, capture_output=True)

    idx = ROOT / "episodes" / EP / "06_audio" / "short14_narration_index.v002.en_us.json"
