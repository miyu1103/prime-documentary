...
# (line_id, delivery, spoken_text) — EP34 Rolin / Brown v. TSA (airport cash civil forfeiture). R2.
# WORDING LOCKS (per EP34 §1 FACTS LOCKED — hedge, government-neutral, no likeness):
#   - Amount HEDGED: "about eighty-two thousand dollars" (no precise $82,373, no exact date).
#   - Domestic-flight cash is LEGAL: no limit, no reporting requirement (reporting only applies to
#     international travel over $10,000). This is the load-bearing legal point.
#   - No one was charged with a crime. Civil forfeiture = the money itself is the defendant; the owner
#     must go to court to get it back.
#   - Institute for Justice sued (Brown v. TSA, a class action). In 2022 the case ended in a SETTLEMENT.
#     By 2025 the DEA had ended its program of seizing cash at airports (agency subject, neutral).
#   - The government RETURNED Terry Rolin's savings. No named agents/officials. No real-person likeness.
LINES: list[tuple[str, str, str]] = [
    ("L1", "intense", "You can fly with your life savings in cash — it's completely legal. But at the airport, the government can take it, and never charge you with a crime."),
    ("L2", "building", "That's what happened to Terry Rolin. He had saved about eighty-two thousand dollars in cash over a lifetime. When his daughter flew with it to put it in the bank, agents at the airport stopped her and seized every dollar — on suspicion alone."),
    ("L3", "building", "But on a domestic flight there is no limit on the cash you can carry, and no form to file. No one was charged with anything. Under civil forfeiture, the money itself is treated as guilty — and you have to go to court to prove your own cash is innocent."),
    ("L4", "intense", "The Institute for Justice sued on behalf of travelers like them. In 2022 the case ended in a settlement, and by 2025 the D-E-A had shut down its program of seizing cash at airports. The government gave Terry his savings back — but most people never get that far."),
...
def main() -> int:
    ...
    master = media_root() / "episodes" / EP / "06_voice" / "master" / "short34_vc_master_en_us_v002.mp3"
    master.parent.mkdir(parents=True, exist_ok=True)
    subprocess.run(["ffmpeg", "-y", "-f", "concat", "-safe", "0", "-i", str(concat),
                    "-c:a", "libmp3lame", "-b:a", "192k", str(master)], check=True, capture_output=True)

    idx = ROOT / "episodes" / EP / "06_audio" / "short34_narration_index.v002.en_us.json"
