...
SCRIPT_SRC = ROOT / "episodes" / "_planning" / "EP48_glover_script.en.v001.md"
SOURCE_SCRIPT_REL = "episodes/_planning/EP48_glover_script.en.v001.md"
...
SECTION_HEADINGS = [
    ("HOOK", re.compile(r"^\[HOOK\]", re.IGNORECASE)),
    ("OP", re.compile(r"^\[OPENING\]", re.IGNORECASE)),
    ("ACT_1", re.compile(r"^\[ACT_1\]", re.IGNORECASE)),
    ("ACT_2", re.compile(r"^\[ACT_2\]", re.IGNORECASE)),
    ("ACT_3", re.compile(r"^\[ACT_3\]", re.IGNORECASE)),
    ("ENDING", re.compile(r"^\[ENDING\]", re.IGNORECASE)),
]
