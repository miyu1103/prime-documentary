...
MEDIA_AI = Path("E:/pd-media/assets/ai/morton")
MEDIA_VIDEO = Path("E:/pd-media/assets/ai_video/morton")
FACTORY_MEDIA = Path("E:/pd-media/assets")
STOCK_VIDEO = Path("E:/pd-media/assets/stock/video")
