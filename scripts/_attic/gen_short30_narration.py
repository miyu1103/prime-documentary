...
# (line_id, delivery, spoken_text) — from SHORTS_EP19-24.md SHORT #24 time table, with R2 wording locks applied.
LINES: list[tuple[str, str, str]] = [
    ("L1", "intense", "In a courtroom she looked at the man who attacked her and swore she was certain. She was completely wrong."),
    ("L2", "building", "In 1984, in Burlington, North Carolina, a college student named Jennifer Thompson was attacked at knifepoint. She forced herself to memorize her attacker's face. Police showed her a photo lineup, then a live lineup, and both times she chose a man named Ronald Cotton."),
    ("L3", "building", "But Cotton was the only person who appeared in both lineups. By the live lineup, she may have been recognizing the police photo, not her attacker. Detectives told her she'd done great — and that quiet reassurance hardened a careful guess into total certainty. In 1985, it sent Cotton to prison."),
    ("L4", "intense", "He served more than a decade. Then in 1995, DNA testing excluded Ronald Cotton and matched the real attacker — a lookalike inmate named Bobby Poole, who later pleaded guilty. Cotton walked free. Here is the part no one expects: he and Jennifer became close friends and advocates who helped reform how police run a lineup."),
...
def main() -> int:
    ...
    master = media_root() / "episodes" / EP / "06_voice" / "master" / "short30_vc_master_en_us_v002.mp3"
    master.parent.mkdir(parents=True, exist_ok=True)
    subprocess.run(["ffmpeg", "-y", "-f", "concat", "-safe", "0", "-i", str(concat),
                    "-c:a", "libmp3lame", "-b:a", "192k", str(master)], check=True, capture_output=True)

    idx = ROOT / "episodes" / EP / "06_audio" / "short30_narration_index.v002.en_us.json"
