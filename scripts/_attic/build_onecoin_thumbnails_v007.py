#!/usr/bin/env python3
"""Render OneCoin thumbnail candidates v007 (flashier variant)."""
...
OPTION_OPTIONS = [
    {
        ...
        "output": THUMB_DIR / "thumbnail.onecoin_option_A.v007.png",
    ...
    },
    {
        ...
        "output": THUMB_DIR / "thumbnail.onecoin_option_B.v007.png",
    ...
    },
    {
        ...
        "output": THUMB_DIR / "thumbnail.onecoin_option_C.v007.png",
...
def copy_selected_thumbnail(options: list[dict], selected_index: int = 0) -> Path:
    ...
    selected_file = PACKAGE_DIR / "thumbnail.selected.v007.png"
...
def build_package() -> None:
    ...
    write_json(PACKAGE_DIR / "title_thumbnail_candidates.v007.json", title_meta)
