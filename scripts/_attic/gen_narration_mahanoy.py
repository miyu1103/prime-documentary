#!/usr/bin/env python3
"""Generate PD-2026-011 Mahanoy narration with the channel ElevenLabs voice.

Paid ElevenLabs API call. Owner explicitly authorized nonstop EP11 narration in
the Codex thread. Idempotent: current chunks with matching idempotency keys are
skipped.
"""
...
APPROVAL_ID = "CHAT-EP11-NONSTOP-OWNER"
