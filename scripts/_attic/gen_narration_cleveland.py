...
SCRIPT_SRC = ROOT / "episodes" / "_planning" / "EP45_cleveland_script.en.v001.md"
SOURCE_SCRIPT_REL = "episodes/_planning/EP45_cleveland_script.en.v001.md"
...
SECTION_HEADINGS = [
    ...
    ("ACT_1", re.compile(r"^ACT\s*1\b", re.IGNORECASE)),
    ("ACT_2", re.compile(r"^ACT\s*2\b", re.IGNORECASE)),
    ("ACT_3", re.compile(r"^ACT\s*3\b", re.IGNORECASE)),
