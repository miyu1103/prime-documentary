#!/usr/bin/env python3
"""EP42 young: replace the baked narration with the authoritative master VO and add a
...
Usage: python scripts/build_young_bgm_real.py <render_in.mp4> <final_out.mp4>
"""
...
def main() -> int:
    ...
    work = out.parent / "_young_bgm_pre.wav"
