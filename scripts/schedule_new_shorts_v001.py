#!/usr/bin/env python3
"""Schedule the 6 new Shorts (short38-43) to YouTube (private + publishAt).
...
SHORTS = [
    {"n": 38, "publishAt": "2026-08-02T03:00:00Z",
     "title": "Police Arrested Him Because Software Matched His Face #Shorts",
     "desc": "A facial-recognition system flagged an innocent man from a grainy photo, and police arrested him on that alone. A face-match is a lead, not proof."},
    {"n": 39, "publishAt": "2026-08-03T03:00:00Z",
     "title": "He Paid the Fine Early. Strip-Searched Anyway. #Shorts",
     "desc": "Albert Florence was arrested over a fine he had already paid, then strip-searched at intake. In Florence v. Board (2012), the Supreme Court allowed it, 5-4."},
    {"n": 40, "publishAt": "2026-08-04T03:00:00Z",
     "title": "Judges Took $2.8M to Send Kids to Jail #Shorts",
     "desc": "In the Kids-for-Cash scandal, judges accepted millions while children were funneled into a for-profit detention facility. Thousands of cases were later vacated."},
    {"n": 41, "publishAt": "2026-08-05T03:00:00Z",
     "title": "Police Invented the Evidence, and It Was Legal #Shorts",
     "desc": "Police told a suspect his fingerprints were at the scene. There were none. Under Frazier v. Cupp, that kind of deception in an interrogation is legal."},
    {"n": 42, "publishAt": "2026-08-06T03:00:00Z",
     "title": "Police Destroyed His House Chasing a Stranger. He Got Nothing. #Shorts",
     "desc": "An armed stranger picked a family's house at random and barricaded inside. Police breached and gassed it. The Supreme Court declined to hear the owner's case."},
    {"n": 43, "publishAt": "2026-08-07T03:00:00Z",
     "title": "They Hid the Proof He Was Innocent for 14 Years #Shorts",
     "desc": "Prosecutors hid blood evidence that cleared John Thompson; he spent 14 years on death row. In Connick v. Thompson (2011), the Court, 5-4, let him recover nothing."},
]
